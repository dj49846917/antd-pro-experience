...
import { PageInfo, TableListParamsBackType } from "@/pages/template/table/TablePaginationBefore/type"
...
function UploadComponent() {
  ...
  return (
    <PageContainer
    >
      <Button type="primary" onClick={() => setVisible(true)}>导入</Button>
      <Table
        pagination={{
        ...
        onChange={changePage}
      />
      <Modal confirmLoading={loading} title="导入" open={visible} onOk={saveModal} onCancel={() => setVisible(false)} width="40%">
        <Form
          name="add_form"
          form={form}
