export default {
  ...
  'menu.template': '模板',
  'menu.template.modaldemo': '弹框子组件',
  'menu.template.moremodaldemo': '多个弹框子组件',
  'menu.template.mergecell': '单元格合并',
  'menu.template.desk': '跳转页面',
  'menu.template.target': '跳转接收参数页面',
  'menu.template.childmodal': '弹框在子页面和孙页面',
  'menu.template.upload': '上传组件传参数',
  'menu.template.tableradio': '点击选中一条数据',
  'menu.template.datainteration': '前后端数据交互',
  'menu.template.tabletest': 'tab批量增删改',
  'menu.template.selectmoredata': '下拉框选中传递多个值',
  'menu.template.tablesetdata': '表格中输入框有初始值并修改',
