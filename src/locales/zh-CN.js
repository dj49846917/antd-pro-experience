export default {
  ...
  'menu.template': '模板',
  'menu.template.modaldemo': '弹框',
  'menu.template.modaldemo.modal': '弹框子组件',
  'menu.template.modaldemo.moremodaldemo': '多个弹框子组件',
  'menu.template.modaldemo.childmodal': '弹框在子页面和孙页面',
  'menu.template.table': '表格',
  'menu.template.table.mergecell': '单元格合并',
  'menu.template.table.tableradio': '点击选中一条数据',
  'menu.template.table.datainteration': '前后端数据交互',
  'menu.template.table.tabletest': 'table批量增删改',
  'menu.template.table.tablesetdata': '表格中输入框有初始值并修改',
  'menu.template.table.dynamictable': '动态表格',
  'menu.template.table.tablepagination': '表格分页(后端分)',
  'menu.template.table.tablepaginationbefore': '表格分页(前端分)',
  'menu.template.desk': '跳转页面',
  'menu.template.target': '跳转接收参数页面',
  'menu.template.upload': '上传组件传参数',
  'menu.template.selectmoredata': '下拉框选中传递多个值',
  'menu.template.setstatedemo': '解构改变state',
  'menu.template.formcheck': 'Form表单自定义校验',
  'menu.template.datepickerdemo': '日期组件',
  'menu.test': '公共组件测试',
